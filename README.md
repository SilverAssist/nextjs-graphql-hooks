...
1. **Download the Plugin**: Download the `nextjs-graphql-hooks-v1.1.0.zip` file from the [releases page](https://github.com/SilverAssist/nextjs-graphql-hooks/releases)
...
wp plugin install https://github.com/SilverAssist/nextjs-graphql-hooks/releases/latest/download/nextjs-graphql-hooks-v1.1.0.zip --activate
